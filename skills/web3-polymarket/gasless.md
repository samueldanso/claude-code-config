...
Polymarket's **Relayer Client** enables gasless transactions. Instead of requiring users to hold POL, Polymarket's infrastructure pays gas fees. Users only need USDC.
...
| Token approvals | Approve contracts to spend USDC or outcome tokens |
...
const response = await client.execute([approveTx], "Approve USDC for CTF");
await response.wait();
```
...
| CTF | `0x4D97DCd97eC945f40cF65F87097ACe5EA0476045` | USDC |
| CTF Exchange | `0x4bFb41d5B3570DeFd03C39a9A4D8dE6Bd8B8982E` | USDC, Tokens |
| Neg Risk CTF Exchange | `0xC5d563A36AE78145C45a50134d48A1215220f80a` | USDC, Tokens |
