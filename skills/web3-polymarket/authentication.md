...
|------|-------|-------------|
| EOA | `0` | Standard Ethereum wallet. Funder = wallet address. Needs POL for gas. |
| POLY_PROXY | `1` | Magic Link users who exported PK from Polymarket.com. |
| GNOSIS_SAFE | `2` | Most common. Gnosis Safe multisig proxy wallet. Use for new integrations. |
