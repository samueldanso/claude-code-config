...
| Address | Use For |
|---------|---------|
| `evm` | Ethereum, Arbitrum, Base, Optimism, BNB, HyperEVM, Abstract, Monad |
| `svm` | Solana |
| `btc` | Bitcoin |
...
| Base | EVM | $2 | ETH, USDC, USDT, cbBTC |
| Optimism | EVM | $2 | ETH, OP, USDC, USDT |
| BNB Smart Chain | EVM | $2 | BNB, USDC, USDT, BUSD |
| Solana | SVM | $2 | SOL, USDC, USDT, TRUMP |
| Bitcoin | BTC | $9 | BTC |
| Tron | TVM | $9 | USDT |
| HyperEVM | EVM | $2 | HYPE, USDC, USDe |
...
|--------|----------|-------------|
| `DEPOSIT_DETECTED` | No | Funds detected on source chain |
